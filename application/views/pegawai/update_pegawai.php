                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo $action; ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <?php }else{ ?>
                        <img src="<?php echo base_url('upload/'.$foto);?>" height="83px" width="83px">
                        <input type="hidden" id="foto" name="foto" value="<?php echo $foto; ?>"/>
                        <?php } ?>
                        Ubah Gambar<input class="form-control-file <?php echo form_error('foto') ? 'is-invalid':'' ?>" type="file" id="foto" name="foto"/>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select class="form-control" name="id_agama" id="id_agama">
                                <?php foreach ($agama as $a) : ?>
                                  <option selected="<?php echo $a['id_agama']; ?>"><?php echo $a['nama_agama']; ?></option>   
                                <?php endforeach; ?>
                                <?php foreach ($agama1 as $a1) : ?>
                                  <option value="<?php echo $a1['id_agama']; ?>"><?php echo $a1['nama_agama']; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select class="form-control" name="id_jabatan" id="id_jabatan">
                                <?php foreach ($jabatan as $j) : ?>
                                  <option selected="<?= $j['id_jabatan']; ?>"><?= $j['nama_jabatan']; ?></option>
                                <?php endforeach; ?>
                                <?php foreach ($jabatan1 as $j1) : ?>
                                  <option value="<?= $j1['id_jabatan']; ?>"><?= $j1['nama_jabatan']; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <?php foreach ($golongan as $g) : ?>
                                  <option selected="<?= $g['id_golongan']; ?>"><?= $g['nama_golongan']; ?></option>
                                <?php endforeach; ?>
                              <?php foreach ($golongan1 as $g1) : ?>
                                  <option value="<?= $g1['id_golongan']; ?>"><?= $g1['nama_golongan']; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>

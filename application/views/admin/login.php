              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  if($this->session->flashdata('message')){
                      echo '<p class="warning" style="margin: 10px 20px; color: red; text-align: center;">'.$this->session->flashdata('message').'</p>';
                  }
                  //Cetak error
                  echo validation_errors('<p class="warning" style="margin: 10px 20px; color: red; text-align: center;">','</p>');
                  ?>

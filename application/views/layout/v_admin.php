...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'assets/date/css/bootstrap-datetimepicker.css'?>"/>
    <script src="<?php echo base_url().'assets/date/js/bootstrap.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/date/js/moment-with-locales.js'?>"></script>
    <script src="<?php echo base_url().'assets/date/js/jquery-1.11.3.min.js'?>"></script>
    <script src="<?php echo base_url().'assets/date/js/bootstrap-datetimepicker.js'?>"></script>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url('page/home')?>" class="site_title"><img style="width: 15%;" src="<?php echo base_url().'assets/logo.png'?>"><span>E-Cuti</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                ...
                // $this->db->join('db_pegawai','db_user.id_user=db_pegawai.id_user');
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-users"></i> Pegawai <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo base_url('page/profile')?>">Profile Akun</a></li>
                    </ul>
                  </li>
                  <?php
                    }
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" >
                <span class="glyphicon glyphicon-off" aria-hidden="true" data-toggle="modal" data-target=".bs-example-modal-sm"></span>
              </a>

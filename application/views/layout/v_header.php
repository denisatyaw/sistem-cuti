                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-users"></i> Pegawai <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                            ...
                            <li><a href="<?php echo base_url('page/data_pegawai')?>">Manajemen Pegawai</a></li>
                  ...
                  -->
                  <li><a><i class="fa fa-edit"></i>Data Pegawai <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('page/data_pegawai')?>">Data Pegawai</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i>Cuti <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      ?>  
                      <li><a href="<?php echo base_url('cuti/input_cuti')?>">Pengajuan Cuti</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
